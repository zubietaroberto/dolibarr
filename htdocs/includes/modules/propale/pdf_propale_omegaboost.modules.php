 ...
 */
class pdf_propale_omegaboost extends ModelePDFPropales
{
	 ...
	 */
	function pdf_propale_omegaboost($db)
	{
		...
		$this->db = $db;
		$this->name = "Omegaboost";
		$this->description = "Basado en azur para Serdelpanama";
