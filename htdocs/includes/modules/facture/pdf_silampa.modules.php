 ...
 *	\version    $Id: pdf_crabe.modules.php,v 1.265.2.1 2010/08/31 20:50:37 eldy Exp $
 */
...
class pdf_crabe extends ModelePDFFactures
{
	...
	function pdf_crabe($db)
	{
		...
		$this->db = $db;
		$this->name = "Silampa";
		$this->description = "Basado en crabe para SerDelPaanama";
	...
	function _pagehead(&$pdf, $object, $showaddress=1, $outputlangs)
	{
		...
		//fila cambiada para Serdelapanama
		$title="Descripcion de productos Facturados";
